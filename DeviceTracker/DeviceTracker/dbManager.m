...
- (BOOL)insertData{
    ...
    if (sqlite3_open(dbpath, &_deviceTrackerDB) == SQLITE_OK)
    {
        NSString *combinedSQL = [NSString stringWithFormat:
                                 ...
                                 "(\"PNI-QA-MTD-001\", \"iPhone 5 (Black)\",       \"Apple\",   \"7.1\",   \"4 inch\",   \"Eddie\",  \"now\"),"
                                 "(\"PNI-QA-MTD-027\", \"iPhone 5 S (Gold)\",      \"Apple\",   \"8.0\" ,  \"4 inch\",   \"Victor\", \"now\"),"
                                 "(\"PNI-QA-MTD-035\", \"iPhone 5 C (Green)\",     \"Apple\",   \"7.1.2\", \"4 inch\",   \"Arthur\", \"now\"),"
                                 "(\"PNI-QA-MTD-037\", \"iPhone 6 (Space Gray)\",  \"Apple\",   \"8.0.2\", \"4.7 inch\", \"Eddie\",  \"now\"),"
                                 "(\"PNI-QA-MTD-003\", \"iPod Touch 4\",           \"Apple\",   \"6.1.6\", \"3.5 inch\", \"Ted\",    \"now\"),"
                                 "(\"PNI-QA-MTD-032\", \"iPad Mini (White)\",      \"Apple\",   \"8.0\",   \"7.9 inch\", \"Eddie\",  \"now\"),"
                                 "(\"PNI-QA-MTD-025\", \"iPad Mini (Black)\",      \"Apple\",   \"7.1.2\", \"7.9 inch\", \"Eddie\",  \"now\"),"
                                 "(\"PNI-QA-MTD-030\", \"Galaxy S5 (Navy)\",       \"Samsung\", \"4.4.2\", \"5.1 inch\", \"WES\",    \"now\"),"
                                 "(\"PNI-QA-MTD-033\", \"Galaxy S5 (While)\",      \"Samsung\", \"4.4.2\", \"5.1 inch\", \"XYZ\",    \"now\"),"
                                 "(\"PNI-QA-MTD-034\", \"Galaxy S5 (While)\",      \"Samsung\", \"4.4.2\", \"5.1 inch\", \"ABC\",    \"now\"),"
                                 "(\"PNI-QA-MTD-013\", \"Optimus\",                \"LG\",      \"4.4.4\", \"7 inch\",   \"DDD\",    \"now\"),"
                                 "(\"PNI-QA-MTD-009\", \"Google Nexus 7\",         \"ASUS\",    \"4.4.4\", \"7 inch\",   \"EEE\",    \"now\"),"
                                 "(\"PNI-QA-MTD-031\", \"G-Pad (White)\",          \"LG\",      \"4.4.4\", \"8.3 inch\", \"GGG\",    \"now\")"
                                 ";"];
